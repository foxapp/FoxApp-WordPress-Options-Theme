...
$creativeto_custom_plugin_tabs = array(
		array(
			'label' => __('Backgrounds', 'creativeto'),
			'id'	=> $prefix.'backgrounds',
			'icon'  => CREATIVETOCUSTOMPLUGINPATCH.'/backgrounds/assets/icon.png',
			'menu_position'  => 3,
			'submenu'=>array(
				array(
				'label'=> __('Headers', 'creativeto'),
				'id'	=> $prefix.'headers_backgrounds',
				),
				array(
				'label'=> __('Content area', 'creativeto'),
				'id'	=> $prefix.'content_backgrounds',
				),
				array(
				'label'=> __('Footer', 'creativeto'),
				'id'	=> $prefix.'footer_backgrounds',
				)
			),
		)
);
...
$creativeto_custom_plugin_tabs = array(
		array(
			'label' => sprintf(__('Backgrounds %s', 'creativeto'),$not_compatible_custom_plugin),
			'icon'  => CREATIVETOCUSTOMPLUGINPATCH.'/backgrounds/assets/icon.png',
			'menu_position'  => 3
		)
);
