...
$creativeto_custom_plugin_tabs = array(
		array(
			'label' => __('Widgets', 'creativeto'),
			'id'	=> $prefix.'widgets',
			'icon'  => CREATIVETOCUSTOMPLUGINPATCH.'/widgets/assets/icon.png',
			'menu_position'  => 3,
			'submenu'=>array(
				array(
				'label'=> __('Widgets', 'creativeto'),
				'id'	=> $prefix.'widgets_settings',
				)
			),
		)
);
...
$creativeto_custom_plugin_tabs = array(
		array(
			'label' => sprintf(__('Widgets %s', 'creativeto'),$not_compatible_custom_plugin),
			'icon'  => CREATIVETOCUSTOMPLUGINPATCH.'/widgets/assets/icon.png',
			'menu_position'  => 3
		)
);
