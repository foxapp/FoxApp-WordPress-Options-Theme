...
Tags: the options, option, options, site options, get_option, customization, admin, theme options, code, comments, CSS, extension, Formatting, images, manager, theme
...
1. Upload the entire 'easy-theme-options' folder to the '/wp-content/plugins/' directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Edit includes/options.php file (see documention under settings > Help tab)

== Screenshots ==

1. The main screen
2. Special fields types
3. Advanced Fields Types
4. Other advanced Fields Types
5. Code to create Fields (documentation included)
6. Import / Export feature
7. Shortcodes to display data
8. Help (included)
